...
title = "Personal Model Learning Curve: Subject " + str(n)
...
cv = cross_validation.ShuffleSplit(subject1.shape[0], n_iter=100, test_size=0.2, random_state=0)



plot_learning_curve(estimator, title, subject_x, subject_y, ylim=(0.7, 1.01), cv=cv, n_jobs=6)
